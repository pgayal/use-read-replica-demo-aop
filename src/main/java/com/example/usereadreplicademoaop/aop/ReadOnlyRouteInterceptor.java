 ...
 * a @ReadReplicaQuery annotation. For all of such method it changes the datasource context to route queries to read-replica
 *
 * @author pgayal
...
public class ReadOnlyRouteInterceptor {
    ...
    @Around("@annotation(readReplicaQuery)")
    public Object proceed(ProceedingJoinPoint proceedingJoinPoint, ReadReplicaQuery readReplicaQuery) throws Throwable {
        try {
